...
class EmailConfirmation extends Component {
    ...
    /**
     * Constructs an instance of EmailConfirmation with the provided settings.
     * @constructor
     ...
     * @param {string} settings.confirmationURL - URL for confirming the user's email address.
